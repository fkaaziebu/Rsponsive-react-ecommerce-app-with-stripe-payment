        ...
        <Box width="80%" m="80px auto">
            <Box display="flex" flexWrap="wrap" columnGap="40px">
                ...
                <Box flex="1 1 40%" mb="40px">
                    <img alt={item?.name} width="100%" height="100%" src={`http://localhost:2000${item?.attributes?.image?.data?.attributes?.formats?.medium?.url}`} style={{ objectFit: "contain" }} />
                </Box>
                ...
                <Box flex="1 1 50%" mb="40px">
                    ...
                    <Box display="flex" alignItems="center" minHeight="50px">
                        ...
                        <Button sx={{backgroundColor: "#222222", color: "white", borderRadius: 0, minWidth: "150px", padding: "10px 40px"}} onClick={() => dispatch(addToCart({item: {...item, count}}))}>
                            ADD TO CART
                        </Button>
                    </Box>
                    <Box>
